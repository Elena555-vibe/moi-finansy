...
const categoryDefinitions = [
  ...
  ['food_delivery', 'Кафе, рестораны, доставка еды', 'food_delivery', ['cafe', 'restaurants', 'delivery']],
  ...
  ['subscriptions', 'Подписки и цифровые сервисы', 'subscriptions', []],
  ['gifts', 'Подарки и благотворительность', 'gifts', ['Подарки']],
